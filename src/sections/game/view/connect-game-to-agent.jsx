...
const columns = [
  { field: 'id', headerName: '', align: 'center', headerAlign: 'center', width: 40, },
  {
    field: 'logo',
    width: 60,
    headerName: 'LOGO',
...
export function ConnectGameToAgents() {
  ...
  return (
    <DashboardContent maxWidth="xl">
      <PageTitle>Connect Games To Agents</PageTitle>
      <Grid container sx={{ backgroundColor: "rgba(0,0,0,.3)", display: "flex" }} >
        <Grid size={6} pr={2}>
          ...
          <Block title="Agents Treeview" headerAction={<Box sx={{ display: "flex", gap: "20px" }}>
            <Button variant="contained" color="info">Select All/Cancel All</Button>
          </Box>} footerAction={<Box><Button fullWidth variant="contained" color="info">Connect Games To Agents</Button>
            <Button fullWidth variant="contained" color="error">Disconnect Games To Agents</Button></Box>} >
            <RichTreeView
              checkboxSelection
              aria-checked
        ...
        <Grid size={6} pl={2}>
          ...
          <Block
            title={`Games List (Total:${Games.length})`}
          >
            <DataGrid
              rows={Games}
              checkboxSelection
